...
namespace VideoIndexerArm
{
    public class Program
    {
        ...
        private const string SubscriptionId = "7c27312f-200e-47f6-a855-c308a26f1493";
        private const string ResourceGroup = "proteus";
        private const string AccountName = "protovideoindexer";
        ...
        private const string connectionString = "DefaultEndpointsProtocol=https;AccountName=demoproteusstr;AccountKey=rxbv2sVFKHCSle2lv5+8GfFs4sknl2sHZ0M298h9Tb65YWxtvwGM9uDwvULIgVDEvZmYxlrXr9bK+AStqNaVng==;EndpointSuffix=core.windows.net";
        private const string storageAccount = "https://demoproteusstr.blob.core.windows.net/";
